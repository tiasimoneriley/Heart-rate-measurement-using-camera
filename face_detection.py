    ...
    def face_detect(self, frame):
        ...
        if len(rects) > 0:
            ...
            if face_frame.shape[:2][1] != 0:
                imutils.resize(face_frame, width=256)
            ...
            if len(rectsf) > 0:
                ...
                # right cheek
                ROI1 = face_frame[shape[29][1]:shape[33][1], shape[54][0]:shape[12][0]]

                # left cheek
                ROI2 = face_frame[shape[29][1]:shape[33][1], shape[4][0]:shape[48][0]]
